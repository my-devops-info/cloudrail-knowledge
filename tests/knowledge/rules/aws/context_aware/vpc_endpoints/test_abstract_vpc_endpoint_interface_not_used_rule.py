...
from knowledge.context.aliases_dict import AliasesDict
from knowledge.context.aws.aws_connection import ConnectionDirectionType, PolicyConnectionProperty, PublicConnectionDetail
from knowledge.context.aws.ec2.ec2_instance import Ec2Instance
from knowledge.context.aws.ec2.network_interface import NetworkInterface
from knowledge.context.aws.ec2.subnet import Subnet
from knowledge.context.aws.ec2.vpc import Vpc
...
class TestEc2VpcEndpointExposureRule(unittest.TestCase):
    ...
    def test_vpc_endpoint_ec2_exposure_fail(self):
        ...
        context = EnvironmentContext(vpcs=AliasesDict(vpc),
                                     ec2s=[ec2],
